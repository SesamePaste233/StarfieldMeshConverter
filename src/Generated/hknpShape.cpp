...
bool hktypes::hknpShape::FromInstance(const hkreflex::hkClassInstance* instance) {
	...
	if (class_instance && class_instance->type->type_name != "hknpShape") {
		std::cout << "hknpShape::FromInstance: Wrong type!" << std::endl;
		throw;
	}
...
#ifndef NO_HK_TYPENAME_CHECK
	if (class_instance && class_instance->type->type_name != "hknpShape::FlagsEnum") {
		std::cout << "hknpShape::FlagsEnum::FromInstance: Wrong type!" << std::endl;
		throw;
	}
#endif // NO_HK_TYPENAME_CHECK
...
#ifndef NO_HK_TYPENAME_CHECK
	if (class_instance && class_instance->type->type_name != "hknpShape") {
		std::cout << "hknpShape::ToInstance: Wrong type!" << std::endl;
		throw;
	}
#endif // NO_HK_TYPENAME_CHECK
...
#ifndef NO_HK_TYPENAME_CHECK
	if (class_instance && class_instance->type->type_name != "hknpShape::FlagsEnum") {
		std::cout << "hknpShape::FlagsEnum::ToInstance: Wrong type!" << std::endl;
		throw;
	}
#endif // NO_HK_TYPENAME_CHECK
