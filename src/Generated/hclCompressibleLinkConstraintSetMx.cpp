...
bool hktypes::hclCompressibleLinkConstraintSetMx::FromInstance(const hkreflex::hkClassInstance* instance) {
	...
	if (class_instance && class_instance->type->type_name != "hclCompressibleLinkConstraintSetMx") {
...
#ifndef NO_HK_TYPENAME_CHECK
	if (class_instance && class_instance->type->type_name != "hclCompressibleLinkConstraintSetMx::Batch") {
...
#ifndef NO_HK_TYPENAME_CHECK
	if (class_instance && class_instance->type->type_name != "hclCompressibleLinkConstraintSetMx::Single") {
...
inline std::vector<std::pair<std::string, std::string>> hktypes::hclCompressibleLinkConstraintSetMx::GetTemplateArgs() { return {
}; };

inline std::vector<std::pair<std::string, std::string>> hktypes::hclCompressibleLinkConstraintSetMx::Batch::GetTemplateArgs() { return {
}; };

inline std::vector<std::pair<std::string, std::string>> hktypes::hclCompressibleLinkConstraintSetMx::Single::GetTemplateArgs() { return {
}; };
