...
bool hktypes::hclTaperedCapsuleShape::FromInstance(const hkreflex::hkClassInstance* instance) {
	...
	if (class_instance && class_instance->type->type_name != "hclTaperedCapsuleShape") {
...
inline std::vector<std::pair<std::string, std::string>> hktypes::hclTaperedCapsuleShape::GetTemplateArgs() { return {
}; };
