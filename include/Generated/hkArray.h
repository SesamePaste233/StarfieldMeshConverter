...
namespace hktypes{
	...
	public:
		...
		inline uint32_t GethkClassHash() override { return 3280267330; };
		inline std::vector<std::pair<std::string, std::string>> GethkClassMembers() override {
			return {
				{ "m_data", "T*<void>" },
				{ "m_size", "int" },
	...
	public:
		...
		inline uint32_t GethkClassHash() override { return 593844592; };
		inline std::vector<std::pair<std::string, std::string>> GethkClassMembers() override {
			return {
				{ "m_data", "T*<void>" },
				{ "m_size", "int" },
	...
	template<>
	class hkArray<hclLocalRangeConstraintSet::LocalConstraint, hkContainerHeapAllocator> : public hkHolderBase {
	public:
		using BaseType = void;
		T*<void> m_data; // Offset: 0
		int m_size; // Offset: 8
		...
		bool ToInstance(hkreflex::hkClassInstance* instance) override;
		inline std::string GethkClassName() override { return "hkArray"; };
		inline std::string GetTranscriptId() override { return "hkArray<hclLocalRangeConstraintSet::LocalConstraint, hkContainerHeapAllocator>"; };
		inline uint32_t GethkClassHash() override { return 3169671714; };
		inline std::vector<std::pair<std::string, std::string>> GethkClassMembers() override {
			return {
				{ "m_data", "T*<void>" },
				{ "m_size", "int" },
	...
	template<>
	class hkArray<hclLocalRangeConstraintSet::LocalStiffnessConstraint, hkContainerHeapAllocator> : public hkHolderBase {
	public:
		using BaseType = void;
		T*<void> m_data; // Offset: 0
		int m_size; // Offset: 8
		...
		bool ToInstance(hkreflex::hkClassInstance* instance) override;
		inline std::string GethkClassName() override { return "hkArray"; };
		inline std::string GetTranscriptId() override { return "hkArray<hclLocalRangeConstraintSet::LocalStiffnessConstraint, hkContainerHeapAllocator>"; };
		inline uint32_t GethkClassHash() override { return 0; };
		inline std::vector<std::pair<std::string, std::string>> GethkClassMembers() override {
			return {
				{ "m_data", "T*<void>" },
	...
	template<>
	class hkArray<hclVolumeConstraintMx::FrameBatchData, hkContainerHeapAllocator> : public hkHolderBase {
	public:
		using BaseType = void;
		T*<void> m_data; // Offset: 0
		int m_size; // Offset: 8
		...
		bool ToInstance(hkreflex::hkClassInstance* instance) override;
		inline std::string GethkClassName() override { return "hkArray"; };
		inline std::string GetTranscriptId() override { return "hkArray<hclVolumeConstraintMx::FrameBatchData, hkContainerHeapAllocator>"; };
		inline uint32_t GethkClassHash() override { return 638634001; };
		inline std::vector<std::pair<std::string, std::string>> GethkClassMembers() override {
			return {
				{ "m_data", "T*<void>" },
				{ "m_size", "int" },
	...
	template<>
	class hkArray<hclVolumeConstraintMx::ApplyBatchData, hkContainerHeapAllocator> : public hkHolderBase {
	public:
		using BaseType = void;
		T*<void> m_data; // Offset: 0
		int m_size; // Offset: 8
		...
		bool ToInstance(hkreflex::hkClassInstance* instance) override;
		inline std::string GethkClassName() override { return "hkArray"; };
		inline std::string GetTranscriptId() override { return "hkArray<hclVolumeConstraintMx::ApplyBatchData, hkContainerHeapAllocator>"; };
		inline uint32_t GethkClassHash() override { return 1088147199; };
		inline std::vector<std::pair<std::string, std::string>> GethkClassMembers() override {
			return {
				{ "m_data", "T*<void>" },
				{ "m_size", "int" },
