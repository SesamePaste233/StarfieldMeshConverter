...
// Class No.92
// Original: T[N]<short, 4> Mapped to c type : std::array<short, 4>
...
class hknpMassDistribution {
	Eigen::Vector4f centerOfMassAndVolume;	// Offset: 0 Unk: 0
	Eigen::Quaternionf majorAxisSpace;	// Offset: 16 Unk: 0
	Eigen::Vector4f inertiaTensor;	// Offset: 32 Unk: 0
};

// Class No.84
// Original: T[N]<hkUint8, 1> Mapped to c type : std::array<uint8_t, 1>
...
class hknpConvexHull::Edge {
	...
	std::array<uint8_t, 1> padding;	// Offset: 3 Unk: 0
};
...
class hknpConvexHull {
	...
	std::vector<Vector4> planes;	// Offset: 8 Unk: 0
...
// Class No.50
// Original: hkQuaternion Mapped to c type : Eigen::Quaternionf
...
class hknpBodyCinfo {
	...
	Eigen::Vector4f position;	// Offset: 48 Unk: 0
	Eigen::Quaternionf orientation;	// Offset: 64 Unk: 0
	Eigen::Vector4f linearVelocity;	// Offset: 80 Unk: 0
	Eigen::Vector4f angularVelocity;	// Offset: 96 Unk: 0
...
// Class No.37
// Original: hkFlags<hknpCollisionFlags::Enum, int> Mapped to c type : hknpCollisionFlags::Enum
