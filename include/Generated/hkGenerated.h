...
// Class No.162
// Original: T[N]<hkUint8, 64> Mapped to c type : std::array<uint8_t, 64>


// Class No.161
// Original: T[N]<hkUint16, 64> Mapped to c type : std::array<uint16_t, 64>
...
class hclObjectSpaceDeformer::FourBlendEntryBlock {
	std::array<uint16_t, 16> vertexIndices;	// Offset: 0 Unk: 0
	std::array<uint16_t, 64> boneIndices;	// Offset: 32 Unk: 0
