...
namespace hktypes {
	...
	protected:
		...
		const std::unordered_map<std::string_view, std::string_view> _map{
			...
			{ "hkArray<hkTransformf, hkContainerHeapAllocator>", "std::vector<Eigen::Matrix4f>" },
			...
			{ "hkArray<hkMatrix4, hkContainerHeapAllocator>", "std::vector<Eigen::Matrix4f>" },
			...
			{ "hkArray<hkTransform, hkContainerHeapAllocator>", "std::vector<Eigen::Matrix4f>" },
			...
			{ "hkColorf", "Eigen::Vector4f" },
			{ "hkReflect::Any", "object" },
			{ "hkVector4f", "Eigen::Vector4f" },
			{ "hkVector4d", "Eigen::Vector4f" },
