...
def capsule_gen_node_group():
	...
	math_006.operation = 'ARCSINE'
	#Value_001
	math_006.inputs[1].default_value = 0.5
	#Value_002
	math_006.inputs[2].default_value = 9.999999747378752e-05
	...
	math_005.operation = 'ARCCOSINE'
	#Value_001
	math_005.inputs[1].default_value = 0.5
	#Value_002
	math_005.inputs[2].default_value = 9.999999747378752e-05
	...
	def arc_instance_node_group():
		...
		#node Math.004
		math_004_1 = arc_instance.nodes.new("ShaderNodeMath")
		...
		#node Math.005
		math_005_1 = arc_instance.nodes.new("ShaderNodeMath")
		math_005_1.operation = 'MULTIPLY'
		#Value_001
		math_005_1.inputs[1].default_value = 2.0
		#Value_002
		...
		#Rotation
		rotate_instances_002.inputs[2].default_value = (0.0, 0.0, 0.5235987901687622)
		#Local Space
		...
		#node Group Output
		group_output = arc_instance.nodes.new("NodeGroupOutput")
		...
		#Rotation
		rotate_instances_004.inputs[2].default_value = (0.0, 0.0, 1.0471975803375244)
		#Local Space
		...
		#Rotation
		rotate_instances_006.inputs[2].default_value = (0.0, 0.0, 1.5707963705062866)
		#Local Space
		...
		#Rotation
		rotate_instances_007.inputs[2].default_value = (0.0, 0.0, 2.094395160675049)
		#Local Space
		...
		#Rotation
		rotate_instances_009.inputs[2].default_value = (0.0, 0.0, 2.6179938316345215)
		#Local Space
		...
		#node Group Input
		group_input = arc_instance.nodes.new("NodeGroupInput")


		#Set locations
		math_004_1.location = (-80.0, 90.245849609375)
		math_005_1.location = (-80.0, -90.245849609375)
		...
		rotate_instances_001.location = (760.0, -160.0)
		realize_instances_001.location = (1140.0, -140.0)
		rotate_instances_002.location = (540.0, -160.0)
		arc.location = (100.0, 49.754150390625)
		group_output.location = (1820.0, -40.0)
		translate_instances_002.location = (920.0, -420.0)
		rotate_instances_003.location = (760.0, -420.0)
		rotate_instances_004.location = (540.0, -420.0)
		geometry_to_instance_001.location = (1380.0, -20.0)
		translate_instances_003.location = (920.0, -680.0)
		rotate_instances_006.location = (540.0, -680.0)
		rotate_instances_005.location = (760.0, -680.0)
		realize_instances_003.location = (1140.0, -660.0)
		realize_instances_002.location = (1140.0, -400.0)
		translate_instances_004.location = (920.0, -960.0)
		rotate_instances_007.location = (540.0, -960.0)
		rotate_instances_008.location = (760.0, -960.0)
		realize_instances_004.location = (1140.0, -940.0)
		translate_instances_005.location = (920.0, -1300.0)
		rotate_instances_009.location = (540.0, -1300.0)
		rotate_instances_010.location = (760.0, -1300.0)
		...
		geometry_to_instance.location = (320.0, 40.0)
		rotate_instances.location = (760.0, 40.0)
		group_input.location = (-460.0, 0.0)
		...
		group_input.width, group_input.height = 146.3162078857422, 100.0

		#initialize arc_instance links
		#math_005_1.Value -> arc.Sweep Angle
		arc_instance.links.new(math_005_1.outputs[0], arc.inputs[6])
		#arc.Curve -> geometry_to_instance.Geometry
		arc_instance.links.new(arc.outputs[0], geometry_to_instance.inputs[0])
		#math_004_1.Value -> arc.Start Angle
		arc_instance.links.new(math_004_1.outputs[0], arc.inputs[5])
		#group_input.Rotation -> rotate_instances.Rotation
		arc_instance.links.new(group_input.outputs[1], rotate_instances.inputs[2])
		#group_input.Angle -> math_004_1.Value
		arc_instance.links.new(group_input.outputs[2], math_004_1.inputs[1])
		#group_input.Angle -> math_005_1.Value
		arc_instance.links.new(group_input.outputs[2], math_005_1.inputs[0])
		#group_input.Radius -> arc.Radius
		arc_instance.links.new(group_input.outputs[3], arc.inputs[4])
		#group_input.Invert Arc -> arc.Invert Arc
		arc_instance.links.new(group_input.outputs[4], arc.inputs[9])
		#rotate_instances.Instances -> translate_instances.Instances
		arc_instance.links.new(rotate_instances.outputs[0], translate_instances.inputs[0])
		#geometry_to_instance.Instances -> rotate_instances.Instances
		arc_instance.links.new(geometry_to_instance.outputs[0], rotate_instances.inputs[0])
		#rotate_instances_001.Instances -> translate_instances_001.Instances
		arc_instance.links.new(rotate_instances_001.outputs[0], translate_instances_001.inputs[0])
		#group_input.Translation -> rotate_instances.Pivot Point
		arc_instance.links.new(group_input.outputs[0], rotate_instances.inputs[3])
		#group_input.Translation -> rotate_instances_001.Pivot Point
		arc_instance.links.new(group_input.outputs[0], rotate_instances_001.inputs[3])
		#group_input.Translation -> translate_instances_001.Translation
		arc_instance.links.new(group_input.outputs[0], translate_instances_001.inputs[2])
		#group_input.Translation -> translate_instances.Translation
		arc_instance.links.new(group_input.outputs[0], translate_instances.inputs[2])
		#group_input.Translation -> rotate_instances_002.Pivot Point
		arc_instance.links.new(group_input.outputs[0], rotate_instances_002.inputs[3])
		#geometry_to_instance.Instances -> rotate_instances_002.Instances
		arc_instance.links.new(geometry_to_instance.outputs[0], rotate_instances_002.inputs[0])
		#rotate_instances_002.Instances -> rotate_instances_001.Instances
		arc_instance.links.new(rotate_instances_002.outputs[0], rotate_instances_001.inputs[0])
		...
		#realize_instances.Geometry -> geometry_to_instance_001.Geometry
		arc_instance.links.new(realize_instances.outputs[0], geometry_to_instance_001.inputs[0])
		#realize_instances_001.Geometry -> geometry_to_instance_001.Geometry
		arc_instance.links.new(realize_instances_001.outputs[0], geometry_to_instance_001.inputs[0])
		#geometry_to_instance_001.Instances -> group_output.Instances
		arc_instance.links.new(geometry_to_instance_001.outputs[0], group_output.inputs[0])
		#group_input.Rotation -> rotate_instances_001.Rotation
		arc_instance.links.new(group_input.outputs[1], rotate_instances_001.inputs[2])
		#rotate_instances_003.Instances -> translate_instances_002.Instances
		arc_instance.links.new(rotate_instances_003.outputs[0], translate_instances_002.inputs[0])
		#rotate_instances_004.Instances -> rotate_instances_003.Instances
		arc_instance.links.new(rotate_instances_004.outputs[0], rotate_instances_003.inputs[0])
		#translate_instances_002.Instances -> realize_instances_002.Geometry
		arc_instance.links.new(translate_instances_002.outputs[0], realize_instances_002.inputs[0])
		#group_input.Translation -> rotate_instances_004.Pivot Point
		arc_instance.links.new(group_input.outputs[0], rotate_instances_004.inputs[3])
		#group_input.Translation -> rotate_instances_003.Pivot Point
		arc_instance.links.new(group_input.outputs[0], rotate_instances_003.inputs[3])
		#group_input.Translation -> translate_instances_002.Translation
		arc_instance.links.new(group_input.outputs[0], translate_instances_002.inputs[2])
		#geometry_to_instance.Instances -> rotate_instances_004.Instances
		arc_instance.links.new(geometry_to_instance.outputs[0], rotate_instances_004.inputs[0])
		#group_input.Rotation -> rotate_instances_003.Rotation
		arc_instance.links.new(group_input.outputs[1], rotate_instances_003.inputs[2])
		...
		#rotate_instances_006.Instances -> rotate_instances_005.Instances
		arc_instance.links.new(rotate_instances_006.outputs[0], rotate_instances_005.inputs[0])
		#translate_instances_003.Instances -> realize_instances_003.Geometry
		arc_instance.links.new(translate_instances_003.outputs[0], realize_instances_003.inputs[0])
		#group_input.Translation -> rotate_instances_006.Pivot Point
		arc_instance.links.new(group_input.outputs[0], rotate_instances_006.inputs[3])
		#group_input.Translation -> rotate_instances_005.Pivot Point
		arc_instance.links.new(group_input.outputs[0], rotate_instances_005.inputs[3])
		#group_input.Rotation -> rotate_instances_005.Rotation
		arc_instance.links.new(group_input.outputs[1], rotate_instances_005.inputs[2])
		#group_input.Translation -> translate_instances_003.Translation
		arc_instance.links.new(group_input.outputs[0], translate_instances_003.inputs[2])
		#realize_instances_003.Geometry -> geometry_to_instance_001.Geometry
		arc_instance.links.new(realize_instances_003.outputs[0], geometry_to_instance_001.inputs[0])
		#realize_instances_002.Geometry -> geometry_to_instance_001.Geometry
		arc_instance.links.new(realize_instances_002.outputs[0], geometry_to_instance_001.inputs[0])
		#geometry_to_instance.Instances -> rotate_instances_006.Instances
		arc_instance.links.new(geometry_to_instance.outputs[0], rotate_instances_006.inputs[0])
		#rotate_instances_008.Instances -> translate_instances_004.Instances
		arc_instance.links.new(rotate_instances_008.outputs[0], translate_instances_004.inputs[0])
		#rotate_instances_007.Instances -> rotate_instances_008.Instances
		arc_instance.links.new(rotate_instances_007.outputs[0], rotate_instances_008.inputs[0])
		...
		#rotate_instances_010.Instances -> translate_instances_005.Instances
		arc_instance.links.new(rotate_instances_010.outputs[0], translate_instances_005.inputs[0])
		#rotate_instances_009.Instances -> rotate_instances_010.Instances
		arc_instance.links.new(rotate_instances_009.outputs[0], rotate_instances_010.inputs[0])
		...
		#group_input.Translation -> reroute.Input
		arc_instance.links.new(group_input.outputs[0], reroute.inputs[0])
		...
		#reroute.Output -> rotate_instances_010.Pivot Point
		arc_instance.links.new(reroute.outputs[0], rotate_instances_010.inputs[3])
		...
		#reroute_001.Output -> rotate_instances_008.Rotation
		arc_instance.links.new(reroute_001.outputs[0], rotate_instances_008.inputs[2])
		#group_input.Rotation -> reroute_001.Input
		arc_instance.links.new(group_input.outputs[1], reroute_001.inputs[0])
		#reroute_001.Output -> rotate_instances_010.Rotation
		arc_instance.links.new(reroute_001.outputs[0], rotate_instances_010.inputs[2])
		#realize_instances_004.Geometry -> geometry_to_instance_001.Geometry
		arc_instance.links.new(realize_instances_004.outputs[0], geometry_to_instance_001.inputs[0])
		#geometry_to_instance.Instances -> rotate_instances_007.Instances
		arc_instance.links.new(geometry_to_instance.outputs[0], rotate_instances_007.inputs[0])
		#geometry_to_instance.Instances -> rotate_instances_009.Instances
		arc_instance.links.new(geometry_to_instance.outputs[0], rotate_instances_009.inputs[0])
		#realize_instances_005.Geometry -> geometry_to_instance_001.Geometry
		arc_instance.links.new(realize_instances_005.outputs[0], geometry_to_instance_001.inputs[0])
		return arc_instance
	...
	#node Group Output
	group_output_1 = capsule_gen.nodes.new("NodeGroupOutput")
	...
	#Set locations
	vector_math_002.location = (560.0, -200.0)
	vector_math_003.location = (720.0, -200.0)
	math_006.location = (1060.0, -320.0)
	math_004.location = (900.0, -160.0)
	math_005.location = (1060.0, -160.0)
	group.location = (1520.0, 40.0)
	join_geometry.location = (2140.0, 40.0)
	group_output_1.location = (2580.0, 40.0)
	math_001.location = (-220.0, -160.0)
	vector_math_001.location = (140.0, -340.0)
	vector_math.location = (340.0, -320.0)
	math_003.location = (140.0, -160.0)
	math_002.location = (-40.0, -160.0)
	group_input_001.location = (-480.0, -300.0)
	group_input_003.location = (1500.0, -380.0)
	vector_math_004.location = (1800.0, -380.0)
	...
	group_input_002.location = (1060.0, 120.0)
	align_euler_to_vector.location = (1980.0, -380.0)
	...
	#group_input_001.bigRadius -> math_001.Value
	capsule_gen.links.new(group_input_001.outputs[2], math_001.inputs[1])
	#group_input_001.smallRadius -> math_001.Value
	capsule_gen.links.new(group_input_001.outputs[3], math_001.inputs[0])
	#math_001.Value -> math_002.Value
	capsule_gen.links.new(math_001.outputs[0], math_002.inputs[1])
	#group_input_001.smallRadius -> math_002.Value
	capsule_gen.links.new(group_input_001.outputs[3], math_002.inputs[0])
	#math_002.Value -> math_003.Value
	capsule_gen.links.new(math_002.outputs[0], math_003.inputs[1])
	#vector_math_001.Vector -> vector_math.Vector
	capsule_gen.links.new(vector_math_001.outputs[0], vector_math.inputs[2])
	#math_003.Value -> vector_math.Vector
	capsule_gen.links.new(math_003.outputs[0], vector_math.inputs[1])
	#math_002.Value -> vector_math_001.Vector
	capsule_gen.links.new(math_002.outputs[0], vector_math_001.inputs[1])
	#group_input_001.Start/Big -> vector_math_001.Vector
	capsule_gen.links.new(group_input_001.outputs[0], vector_math_001.inputs[0])
	#group_input_001.End/Small -> vector_math.Vector
	capsule_gen.links.new(group_input_001.outputs[1], vector_math.inputs[0])
	#vector_math.Vector -> vector_math_002.Vector
	capsule_gen.links.new(vector_math.outputs[0], vector_math_002.inputs[1])
	#group_input_001.End/Small -> vector_math_002.Vector
	capsule_gen.links.new(group_input_001.outputs[1], vector_math_002.inputs[0])
	#vector_math_002.Vector -> vector_math_003.Vector
	capsule_gen.links.new(vector_math_002.outputs[0], vector_math_003.inputs[0])
	#vector_math_003.Value -> math_004.Value
	capsule_gen.links.new(vector_math_003.outputs[1], math_004.inputs[1])
	#group_input_001.smallRadius -> math_004.Value
	capsule_gen.links.new(group_input_001.outputs[3], math_004.inputs[0])
	#math_004.Value -> math_005.Value
	capsule_gen.links.new(math_004.outputs[0], math_005.inputs[0])
	#math_005.Value -> group.Angle
	capsule_gen.links.new(math_005.outputs[0], group.inputs[2])
	#math_004.Value -> math_006.Value
	capsule_gen.links.new(math_004.outputs[0], math_006.inputs[0])
	#math_005.Value -> group_001.Angle
	capsule_gen.links.new(math_005.outputs[0], group_001.inputs[2])
	#group_input_002.Start/Big -> group_001.Translation
	capsule_gen.links.new(group_input_002.outputs[0], group_001.inputs[0])
	#group_input_002.End/Small -> group.Translation
	capsule_gen.links.new(group_input_002.outputs[1], group.inputs[0])
	...
	#group_input_002.bigRadius -> group_001.Radius
	capsule_gen.links.new(group_input_002.outputs[2], group_001.inputs[3])
	#group_input_002.smallRadius -> group.Radius
	capsule_gen.links.new(group_input_002.outputs[3], group.inputs[3])
	#convex_hull.Convex Hull -> group_output_1.Geometry
	capsule_gen.links.new(convex_hull.outputs[0], group_output_1.inputs[0])
	#group_input_003.Start/Big -> vector_math_004.Vector
	capsule_gen.links.new(group_input_003.outputs[0], vector_math_004.inputs[0])
	#group_input_003.End/Small -> vector_math_004.Vector
	capsule_gen.links.new(group_input_003.outputs[1], vector_math_004.inputs[1])
	...
	#group_input_002.Start/Big -> rotate_instances_1.Pivot Point
	capsule_gen.links.new(group_input_002.outputs[0], rotate_instances_1.inputs[3])
	...
	#group_input_002.End/Small -> rotate_instances_001_1.Pivot Point
	capsule_gen.links.new(group_input_002.outputs[1], rotate_instances_001_1.inputs[3])
	#align_euler_to_vector.Rotation -> rotate_instances_001_1.Rotation
	capsule_gen.links.new(align_euler_to_vector.outputs[0], rotate_instances_001_1.inputs[2])
	#align_euler_to_vector.Rotation -> rotate_instances_1.Rotation
	capsule_gen.links.new(align_euler_to_vector.outputs[0], rotate_instances_1.inputs[2])
