...
// Class No.191
// Mapped to c type: hclVolumeConstraint::ApplyData
class hclVolumeConstraint::ApplyData {
	hkVector4 frameVector;	// Offset: 0 Unk: 0
...
// Class No.190
// Mapped to c type: hkArray
template<class tT=hclVolumeConstraint::ApplyData, class tAllocator=hkContainerHeapAllocator>
class hkArray {
	void* m_data;	// Offset: 0 Unk: 0
	int m_size;	// Offset: 8 Unk: 0
	int m_capacityAndFlags;	// Offset: 12 Unk: 0
...
// Class No.189
// Mapped to c type: hclVolumeConstraint::FrameData
class hclVolumeConstraint::FrameData {
	hkVector4 frameVector;	// Offset: 0 Unk: 0
	hkUint16 particleIndex;	// Offset: 16 Unk: 0
	hkReal weight;	// Offset: 20 Unk: 0
};

// Class No.188
// Mapped to c type: hkArray
template<class tT=hclVolumeConstraint::FrameData, class tAllocator=hkContainerHeapAllocator>
class hkArray {
	void* m_data;	// Offset: 0 Unk: 0
	int m_size;	// Offset: 8 Unk: 0
	int m_capacityAndFlags;	// Offset: 12 Unk: 0
...
// Class No.187
// Mapped to c type: hclVolumeConstraint
class hclVolumeConstraint : public hclConstraintSet {
	hkArray frameDatas;	// Offset: 40 Unk: 0
	hkArray applyDatas;	// Offset: 56 Unk: 0
};
...
class hclStandardLinkConstraintSetMx::Single {
	hkReal restLength;	// Offset: 0 Unk: 0
	hkReal stiffnessA;	// Offset: 4 Unk: 0
	hkReal stiffnessB;	// Offset: 8 Unk: 0
	hkUint16 particleA;	// Offset: 12 Unk: 0
	hkUint16 particleB;	// Offset: 14 Unk: 0
};
...
class hclStandardLinkConstraintSetMx::Batch;	// [Undefined]
...
class hclCopyVerticesOperator : public hclOperator {
	...
	hkUint32 outputBufferIdx;	// Offset: 76 Unk: 0
	hkUint32 numberOfVertices;	// Offset: 80 Unk: 0
	hkUint32 startVertexIn;	// Offset: 84 Unk: 0
	hkUint32 startVertexOut;	// Offset: 88 Unk: 0
	hkBool copyNormals;	// Offset: 92 Unk: 0
};
...
class hclBoneSpaceDeformer::TwoBlendEntryBlock;	// [Undefined]
